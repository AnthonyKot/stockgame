...
The approved product direction is [MASTER_PLAN.md](MASTER_PLAN.md). The existing standalone quiz app is the foundation; campaign implementation is upcoming.
...
- Run it: `cd site && python3 -m http.server 8765` and open http://localhost:8765/index.html.
