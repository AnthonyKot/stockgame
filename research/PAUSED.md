...
- Later on 2026-09-10 (Claude): the same block authored for the other nine cases by Sonnet writers under cases/SNAPSHOT_PRESENTATION_BRIEF.md, validated and merged by scripts/merge_presentation.py; label guard added to verify_cases.py; money() formats trillions for the bank. Codex review items 1-3 and 5 done; item 4 (stronger tests) open.
